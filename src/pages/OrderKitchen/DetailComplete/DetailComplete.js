...
import styles from './DetailComplete.module.scss';
//
...
const DetailComplete = () => {
  ...
  const confirm = () => {
    ...
    axios
      .post(
        apiUrl + '/v1/confirm-order-complete',
        {
          idkitchenModule: url[5],
        },
        {
          headers: {
            token: cookieValue(),
    ...
    <div className={cx('wrapper')}>
      <div className={cx('container1')}>
        <div className={cx('container-infor')}>
          ...
          <p>Thời gian nhận order: {moment(Allbill.updatedAt).locale('vi').format('HH:mm DD/MM/YYYY')}</p>
